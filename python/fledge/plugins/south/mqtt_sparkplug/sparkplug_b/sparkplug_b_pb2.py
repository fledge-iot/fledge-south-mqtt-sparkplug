...
_READINGVALUE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value_double', full_name='sparkplug.ReadingValue.value_double', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value_string', full_name='sparkplug.ReadingValue.value_string', index=3,
